...
import (
	...
	"convert-to-dpfm-supply-chain-relationship-from-sap-bp-supplier/config"
	"fmt"
	"time"

	convert_complementer "convert-to-dpfm-supply-chain-relationship-from-sap-bp-supplier/convert_complementer"
...
func getAccepter(input *dpfm_api_input_reader.SDC) []string {
	...
	if accepter[0] == "All" {
		accepter = []string{
			"Transaction", "DeliveryRelation", "BillingRelation", "PaymentRelation",
		}
	}
	return accepter
}
